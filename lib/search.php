<?php
$wd=@$_GET["wd"];
echo "<div class=\"col-md-8 col-md-offset-2\" role=\"main\">            <center><h1>Mi<span style=\"color:#F00\">x</span> Search α </h1>For K<span style=\"color:#F00\">D</span>Cloud</center><br>              <form action=\"./\" method=\"get\">            <div class=\"input-group input-group-lg\">                          <input id=\"in\" type=\"text\" value=\"{$wd}\"class=\"form-control\" name=\"wd\" aria-describedby=\"sizing-addon1\"><span class=\"input-group-btn\">                    <button class=\"btn btn-default\">                        <span class=\"glyphicon glyphicon-search\"></span>               </button>                </span>        </div></div><input type=\"hidden\" name=\"m\" value=\"search\"></form>";
if(strlen($wd)>0){
	$bduss=$_COOKIE['bduss'];
	require './config.php';
